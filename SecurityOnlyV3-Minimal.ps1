# ================================================================
# Minimal-WindowsUpdateSettings_Master.ps1
# ================================================================
# This Windows Update script configures the Windows Operating System to only recieve security-related updates (quality updates)
...
# 3. Validates registry settings for Windows Update related to the Target Release Version
#    and deferred quality updates.
...
if ($InitialRun -or ($TimeSpan.TotalDays -ge 364)) {
    ...
    elseif (($WUSettings.ProductVersion -ne $ProductVersion) -or
            ...
            ($WUSettings.DeferQualityUpdatesPeriodInDays -ne 4)) {
